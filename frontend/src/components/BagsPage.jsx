...
// 🔹 All words that should count as "bags"
const BAGS_KEYWORDS = [
  "bag",
  "purse",
  "clutch",
...
const matchesBags = (p) => {
  ...
  return BAGS_KEYWORDS.some((kw) => category.includes(kw) || name.includes(kw));
};
      ...
      return (
        <div className="text-center py-24 border rounded-xl bg-white shadow-sm">
          <h3 className="text-xl font-semibold text-gray-900 mb-2">
            No items available for {filters.designer} in Bags
          </h3>
        ...
        <div className="flex flex-col items-start mb-8 gap-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 capitalize">
              {sellerMode === "main" ? "Bags" : `${sellerMode} Bags`}
            </h1>
